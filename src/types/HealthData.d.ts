...
export interface DBSleepSession
  extends Omit<SleepSession, "timestamp">,
    DBBase {
...
export interface DBWorkout
  extends Omit<Workout, "timestamp" | "endTimestamp" | "heartRateSamples">,
    DBBase {
...
export interface DBDailyWorkoutSummary
  extends Omit<DailyWorkoutSummary, "date">,
    DBBase {
  workouts?: DBWorkout[];
  userId: number;
  user: DBUser;
...
export interface DBDailySleepSummary
  extends Omit<DailySleepSummary, "timestamp">,
    DBBase {
...
export interface DBHealthDataPoint
  extends Omit<HealthDataPoint, "timestamp">,
    DBBase {
  userId?: number;
  workoutId?: number;
  workout?: Workout;
